...
public class ShowActorServiceImpl implements ShowActorService {
    ...
    @Override
    public ShowActorDTO getActorById(String showActorId) {
    ...
    @Override
    public void updateActor(String showActorId, ShowActorDTO actorDataToChangeDTO) {
    ...
    public void updateActorShowName( String idToUpdate, String updatedName ){
    ...
    @Override
    public void deleteActor(String idToDelete) {
        // First let's get the User by their ID and if not found we need to throw a ResourceNotFoundException
